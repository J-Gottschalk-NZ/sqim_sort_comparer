...
print("**** Quick Sort - How To")
print()
print("This program allows you to see how many comparisons might be needed to \nsort various types "
...
while again == "":
    ...
    if choose_algorithm == "Insertion Sort":
        ...
        print("Note: Whilst merge sort may have fewer comparisons than quick sort, it is not always \n"
              "more efficient.  This tool only counts comparisons and does not take into account \n"
              "the extra space needed by merge sort.")
        print()
        print("Generally we'd use quick sort instead of merge sort.  For a deeper explanation, please\n"
              "google the question.")
        print()
